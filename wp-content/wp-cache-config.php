...
$wp_cache_home_path = '/hostweb/'; //Added by WP-Cache Manager
...
$wp_cache_plugins_dir = WPCACHEHOME . 'plug// set to 1 to do garbage collection during normal process shutdown instead of wp-cron
