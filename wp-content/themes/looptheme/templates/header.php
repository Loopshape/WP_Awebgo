...
<header class="banner" role="banner">
    ...
    <div class="container">
		 ...
		 * */ ?>
        <a class="brand" href="#gotoTop"><img class="mainLogo hastip" title="[Klick] Gehe zur Startseite" src="/wp-content/themes/looptheme/assets/images/AwebgoLogo.png" alt=""></a>
        <nav role="navigation">
            <?php
